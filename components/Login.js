...
export default function Login() {
  ...
  return (
    <div className='flex flex-col flex-1 justify-center items-center gap-4'>
      ...
      <input className='w-full max-w-[400px] mx-auto px-3 duration-200 hover:border-indigo-600 focus:border-indigo-600 py-2 sm:py-3 border border-solid border-indigo-400 rounded-md outline-none  text-black '
      placeholder='Email'
      value={email}
      onChange={(e) => {
